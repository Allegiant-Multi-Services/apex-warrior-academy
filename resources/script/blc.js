...
// =====================
// BLC QUIZ INITIALIZATION
// =====================
document.addEventListener('DOMContentLoaded', () => {
    try {
        const blcQuiz = new QuizModule(questions, {
            showProgress: true,
            allowRetake: true
        });
        console.log('BLC quiz module initialized successfully');
    } catch (error) {
        console.error('Error initializing BLC quiz module:', error);
    }
});